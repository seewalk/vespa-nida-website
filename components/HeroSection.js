...
export default function HeroSection() {
  ...
  const slogans = [
    "Elegance in Motion",
    "Authentic Rides. Timeless Style.",
    "Cruise Nida. Live Vespa."
  ];
    ...
    <section className="relative h-screen w-full flex items-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="relative h-full w-full">
          <Image
            ...
            alt="Vespa scooter on a scenic coastal road in Nida"
            fill
            priority
            sizes="100vw"
      ...
      <div className="container relative z-10 mx-auto px-6">
        ...
        >
          ...
          >
            Experience the scenic beauty of Nida with our luxury Vespa rentals.
            Cruise the Baltic coastline with style and freedom.
          </motion.p>
